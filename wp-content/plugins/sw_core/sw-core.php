...
/*
   ...
   *
  */
  function revo_change_logo( $atts ){
		extract(shortcode_atts(array(
		'title' => '',
		'colorset' => '',
		'post_status' => 'publish',
		...
		if( function_exists( 'revo_options' ) ) {
			...
			$site_logo = revo_options()->getCpanelValue('sitelogo');
			$output   ='';
			$output  .='<div class="ya-logo">';
			$output	 .='<a  href="'.esc_url( home_url( '/' ) ).'">';
						if(revo_options()->getCpanelValue('sitelogo')){
			$output	 .='<img src="'.esc_url( $revo_logo ).'" alt="logo"/>';
						}else{
  ...
  add_shortcode('logo_footer','revo_change_logo');