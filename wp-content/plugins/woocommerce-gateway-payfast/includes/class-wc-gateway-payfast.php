 ...
 * @author		WooThemes
 */
define( 'WC_GATEWAY_PAYFAST_VERSION', '1.4.1' );
...
class WC_Gateway_PayFast extends WC_Payment_Gateway {
	...
	public function scheduled_subscription_payment( $amount_to_charge, $renewal_order ) {
		...
		$subscription = wcs_get_subscription( get_post_meta( $renewal_self::get_order_prop( $order, 'id' ), '_subscription_renewal', true ) );
