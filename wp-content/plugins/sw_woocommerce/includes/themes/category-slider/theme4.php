		...
		?>
			<div class="item item-product-cat">					
				...
				<div class="item-content">
					...
					<div class="shop-now"><a href="<?php echo get_term_link( $term->term_id, 'product_cat' ); ?>"><?php esc_html_e( 'Shop now', 'sw-woocomerce' ) ?><i class="fa fa-angle-double-right"></i></a></div>
				</div>
			</div>
			<?php endif; ?>
		<?php } ?>
