					...
					<div class="item-wrap">
						<div class="item-detail">										
							...
							<div class="item-content">															
								<div class="product-countdown"  data-price="<?php echo esc_attr($orginal_price ); ?>" data-starttime="<?php echo esc_attr( $start_time ); ?>" data-cdtime="<?php echo esc_attr( $countdown_time ); ?>" data-id="<?php echo 'product_'.$id.$post->ID; ?>"></div>
