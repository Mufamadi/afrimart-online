		...
		**/
		function WS_Shortcode_Countdown( $atts, $content = null ){
			...
			if( $layout == 'default' ){
				...
				include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-countdown-slider/tab-countdownt2.php' );			
			}elseif( $layout == 'layout_tab3' ){
				include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-countdown-slider/tab-countdownt3.php' );			
			}
