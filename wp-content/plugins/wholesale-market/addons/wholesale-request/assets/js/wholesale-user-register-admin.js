...
jQuery(document).ready(function($){
	$("#ced_wura_save_notification_setting").click(function(){
	...
	$(".ced_wura_user_request_accept").click(function(e){
	...
	$(".ced_wura_user_request_cancel").click(function(e){
		e.preventDefault();
		var current = $(this);
		var user_id = $(this).data("id");
		var data = {
...
jQuery(document).ready(function(){
	jQuery('#ced_cwsm_request_role_addon_functionality').on('change', function() {
