...
if( !class_exists( 'Wholesale_user_register_notification' ) )
{
	...
	class Wholesale_user_register_notification
	{
		...
		function ced_wura_wholesale_requested_column_orderby( $vars ) {
		...
		function ced_wura_wholesale_requested_column_sortable($columns) {
			$custom = array(
		...
		function ced_wura_wholesale_requested_user_table_row( $val, $column_name, $user_id ) {
			switch ($column_name)
			{
				case 'ced_wura_wholesale_request' :
					...
					$roles['ced_cwsm_wholesale_user'] = array('key'=>'ced_cwsm_wholesale_user' , 'name'=>'Wholesale Customer' , 'quick_note'=>'wholesale customer');
					...
					{
						if( $request != '' && $request != 'accept' && $request != 'cancel' )
						{
		...
		function ced_wura_wholesale_requested_user_table( $column )
		{
		...
		function ced_save_wholesale_notification_callback()
		{
			if(isset($_POST['data']))
			{
		...
		function ced_wura_register_notification_section($sections)
		{
		...
		{
			if($current_section == 'ced_wura_register_notification')
			{
					...
					<tbody>
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_from_name"><?php _e('From Name', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-text">
								<input type="text" placeholder="" class="input-text" value="<?php echo $admin_name;?>" style="" id="ced_wura_notification_from_name" name="ced_wura_notification_from_name">
							</td>
						</tr>
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_from_mail"><?php _e('From Email', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-email">
								<input type="email" placeholder="" class="input-text" value="<?php echo $admin_email;?>" style="" id="ced_wura_notification_from_mail" name="ced_wura_notification_from_mail">
							</td>
						</tr>
						
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_admin_rcv_subject"><?php _e('New Request for Wholesale Role Subject', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-text">
								<input type="text" placeholder="" class="input-text" value="<?php echo $admin_subject;?>" style="" id="ced_wura_notification_admin_rcv_subject" name="ced_wura_notification_admin_rcv_subject">
							</td>
						</tr>
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_admin_rcv_msg"><?php _e('New Request for Wholesale Role Message', 'wholesale-market' ); ?></label>
							</th>
						...
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_rcv_subject"><?php _e('Wholesale Role Request Received Subject', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-text">
								<input type="text" placeholder="" class="input-text" value="<?php echo $user_subject;?>" style="" id="ced_wura_notification_rcv_subject" name="ced_wura_notification_rcv_subject">
							</td>
						</tr>
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_rcv_msg"><?php _e('Wholesale Role Request Received Message', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-textarea">
								<?php 
						...
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_rcv_subject"><?php _e('Wholesale Role Request Accept Subject', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-text">
								<input type="text" placeholder="" class="input-text" value="<?php echo $accept_subject;?>" style="" id="ced_wura_notification_accept_subject" name="ced_wura_notification_accept_subject">
							</td>
						</tr>
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_accept_msg"><?php _e('Wholesale Role Request Accept Message', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-textarea">
								<?php 
						...
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_rcv_subject"><?php _e('Wholesale Role Request Cancel Subject', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-text">
								<input type="text" placeholder="" class="input-text" value="<?php echo $cancel_subject;?>" style="" id="ced_wura_notification_cancel_subject" name="ced_wura_notification_cancel_subject">
							</td>
						</tr>
						<tr valign="top">
							<th class="titledesc" scope="row">
								<label for="ced_wura_notification_cancel_msg"><?php _e('Wholesale Role Request Cancel Message', 'wholesale-market' ); ?></label>
							</th>
							<td class="forminp forminp-textarea">
								<?php 
						...
						<tr valign="top">
							<td class="titledesc" scope="row">
								<input type="button" class="button-primary" id="ced_wura_save_notification_setting" value="<?php _e('Save Setting','wholesale-market'); ?>">
								<img height="20px" src="<?php echo CED_WURA_DIR_URL?>/assets/images/loading.gif" id="ced_wura_loading" style="display:none;">
							</td>
