...
if( !class_exists( 'Wholesale_price_tax' ) ) {
	...
	class Wholesale_price_tax {
		 ...
		 */
		function ced_wura_wholesale_tax_disable( $taxable, $product ) {
		...
		function ced_wura_wholesale_tax_setting($settingReceived,$current_section) {
			if($current_section == 'ced_wura_wholesale_tax')
			{
				$settings = apply_filters( 'ced_cwsm_ced_wura_wholesale_tax_module_setting', array(
		...
		function ced_wura_wholesale_tax_section($sections) {
