...
class CED_CWSM_Min_Product_Qty_Module
{
	 ...
	 * @link  http://www.cedcommerce.com/
	 */
	function ced_cwsm_alter_auto_check_fields( $auto_check_fields ) {
		$auto_check_fields[] = 'ced_cwsm_min_qty_to_buy'.'_enable';
	 ...
	 * @link  http://www.cedcommerce.com/
	 */
	function ced_cwsm_alter_common_fields_for_all_variations( $commonFields ) {
	...
	public function ced_cwsm_min_pro_qty_module_add_variationPro_meta_fields($loop, $variation_data, $variation, $role_identifier='' ) {
		...
		if( $globalCWSM->isHaveToRenderMetaField('ced_cwsm_min_qty_to_buy') ) {
			?>
			<p class="form-field ced_cwsm_min_qty_to_buy<?php echo $role_identifier;?> ">
				<label><?php echo __( 'Minimum Quantity To Buy', 'wholesale-market' ) . ':'; ?></label>
				<input type="text" size="5" name="ced_cwsm_min_qty_to_buy<?php echo $role_identifier;?>[<?php echo $variation->ID; ?>]" value="<?php if ( isset( $variationMinQty ) ) echo esc_attr( $variationMinQty ); ?>" class="wc_input_decimal"  />
	 ...
	 * @link  http://www.cedcommerce.com/
	 */
	function ced_cwsm_isHaveToRender_ced_cwsm_min_qty_to_buy( $isHaveToRender ) {
	...
	{
		update_post_meta( $variationId, 'ced_cwsm_min_qty_to_buy'.$role_identifier, ( $_POST['ced_cwsm_min_qty_to_buy'.$role_identifier][ $variationId ] === '' ) ? '' : sanitize_text_field(wc_format_decimal( $_POST['ced_cwsm_min_qty_to_buy'.$role_identifier][ $variationId ] )) );
	}
	...
	{
		if(strpos($_SERVER['REQUEST_URI'], "&section=ced_cwsm_min_pro_qty_module"))
		{
	...
	{
		if($current_section == 'ced_cwsm_min_pro_qty_module')
		{
			$settings = apply_filters( 'ced_cwsm_min_pro_qty_module_setting', array(
	 ...
	 * @link  http://www.cedcommerce.com/
	 */
	function ced_cwsm_min_pro_qty_module_add_meta_keys_to_be_deleted($metaFieldsToBeDeleted)
	{
	 ...
	 * @link  http://www.cedcommerce.com/
	 */
	function ced_cwsm_min_pro_qty_module_add_options_deleted($optionsToDelArray)
	{
		$optionsAdded = array(
