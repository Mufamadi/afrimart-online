...
jQuery('input[type=radio][name=ced_cwsm_radio_minQty_picker]').change(function() {
...
jQuery('input[type=checkbox][name="ced_cwsm_consider_variations_as_one_common"]').change(function() {
	if(jQuery(this).is(':checked'))
	{
		jQuery('input[type=checkbox][name="ced_cwsm_consider_variations_as_one_individual"]').attr('checked',false);
	}
});
jQuery('input[type=checkbox][name="ced_cwsm_consider_variations_as_one_individual"]').change(function() {
	if(jQuery(this).is(':checked'))
	{
