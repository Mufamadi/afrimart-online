...
jQuery(document).ready(function(){
	...
	jQuery(document.body).on('click','h3#ced_cwsm_csv_module_instruction_heading',function() {
	...
	jQuery(document.body).on('click','button#ced_cwsm_close_csv_import_report',function(event) {
		event.stopPropagation(); // Stop stuff happening
        event.preventDefault(); // Totally stop stuff happening
		jQuery("div#ced_cwsm_csv_processing_div").show().delay(500).fadeOut(function(){
	...
	jQuery(document.body).on('click','button#ced_cwsm_download_error_log',function(event) {
		event.stopPropagation(); // Stop stuff happening
        event.preventDefault(); // Totally stop stuff happening
...
jQuery(function($)
{
	...
	function ced_cwsm_prepareUpload(event)
	{
        ...
        if(fileNameExt != "csv")
        {
			...
			$("div#ced_cwsm_csv_processing_div").show().delay(2000).fadeOut(function(){
				$("div#ced_cwsm_csv_processing_div").html('<img src="'+ced_cwsm_csv_script_js_ajax.loading_image+'">');
