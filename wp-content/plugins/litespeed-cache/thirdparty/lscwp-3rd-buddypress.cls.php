...
/**
 * The Third Party integration with the BuddyPress plugin.
 *
 * @since		1.8.1
...
LiteSpeed_Cache_API::register( 'LiteSpeed_Cache_ThirdParty_BuddyPress' ) ;

class LiteSpeed_Cache_ThirdParty_BuddyPress
{
	/**
