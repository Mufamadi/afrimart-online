...
;(function($, undefined) {
	'use strict';
	// revo image data-uri bypasses webkit log warning (thx doug jones)
	var REVO = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';
	...
	$.fn.imagesLoaded = function( callback ) {
		...
		function imgLoaded( img, isBroken ) {
			// don't proceed if REVO image, or image is already loaded
			if ( img.src === REVO || $.inArray( img, loaded ) !== -1 ) {
				return;
			}
