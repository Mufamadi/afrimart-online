...
class Custom_WC_Widget_Product_Categories extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$revo_pnumber_item 	= ( revo_options()->getCpanelValue( 'product_number_item' ) ) ? revo_options()->getCpanelValue( 'product_number_item' ) : 0;
			$revo_pmore_text 		= ( revo_options()->getCpanelValue( 'product_more_text' ) )	  ? revo_options()->getCpanelValue( 'product_more_text' )		: esc_html__( 'See More', 'revo' );
			$revo_pless_text 		= ( revo_options()->getCpanelValue( 'product_less_text' ) )	  ? revo_options()->getCpanelValue( 'product_less_text' )		: esc_html__( 'See Less', 'revo' );
