<?php
class Revo_Options_button_set extends Revo_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('revo-opts-jquery-ui-css');

		wp_enqueue_script(
			'revo-opts-field-button_set-js', 
			REVO_OPTIONS_URL.'fields/button_set/field_button_set.js', 
