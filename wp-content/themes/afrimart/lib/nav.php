...
function revo_nav_menu_args($args = '') {
	...
	$revo_menu = revo_options()->getCpanelValue( 'menu_location' );
	...
	if (!$args['walker']) {
		if ( 'mega' == revo_options()->getCpanelValue( 'menu_type' ) && $revo_theme_locates[0] != NULL && in_array( $args['theme_location'], $revo_theme_locates ) ){
